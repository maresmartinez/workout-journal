# Phase 4a: Dashboard Page

**Goal:** Build the Dashboard page with quick stats, recent activity, and a "Start Workout" CTA.

**Depends on:** Phase 3 (frontend scaffolding with hooks and shared components)
